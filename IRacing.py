...
class IRacing:
    ...
    def temperature_of_front_right_tire(self) -> str:
        ...
        return DataConverter.float_to_celsius_degrees(
            (self.ir['RFtempCL'] + self.ir['RFtempCM'] + self.ir['RFtempCR']) / 3)
    ...
    def temperature_of_rear_right_tire(self) -> str:
        ...
        """
        return DataConverter.float_to_celsius_degrees(
            (self.ir['RRtempCL'] + self.ir['RRtempCM'] + self.ir['RRtempCR']) / 3)
    ...
    def temperature_of_front_left_tire(self) -> str:
        ...
        """
        return DataConverter.float_to_celsius_degrees(
            (self.ir['LFtempCL'] + self.ir['LFtempCM'] + self.ir['LFtempCR']) / 3)
    ...
    def temperature_of_rear_left_tire(self) -> str:
        ...
        """
        return DataConverter.float_to_celsius_degrees(
            (self.ir['LRtempCL'] + self.ir['LRtempCM'] + self.ir['LRtempCR']) / 3)
